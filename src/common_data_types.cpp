...
std::unordered_map<airport, int> airport_tz = std::unordered_map<airport, int>{
    {ATL, -5}, // Eastern Time (ET)
    {LAX, -8}, // Pacific Time (PT)
    {DFW, -6}, // Central Time (CT)
    {DEN, -7}, // Mountain Time (MT)
    {ORD, -6}, // Central Time (CT)
    {JFK, -5}, // Eastern Time (ET)
    {MCO, -5}, // Eastern Time (ET)
    {LAS, -8}, // Pacific Time (PT)
    {CLT, -5}, // Eastern Time (ET)
    {MIA, -5}, // Eastern Time (ET)
    {SEA, -8}, // Pacific Time (PT)
    {EWR, -5}, // Eastern Time (ET)
    {SFO, -8}, // Pacific Time (PT)
    {PHX, -7}, // Mountain Time (No DST in Arizona)
    {IAH, -6}, // Central Time (CT)
    {BOS, -5}, // Eastern Time (ET)
    {FLL, -5}, // Eastern Time (ET)
    {MSP, -6}, // Central Time (CT)
    {LGA, -5}, // Eastern Time (ET)
    {DTW, -5}, // Eastern Time (ET)
    {PHL, -5}, // Eastern Time (ET)
    {SLC, -7}, // Mountain Time (MT)
    {BWI, -5}, // Eastern Time (ET)
    {DCA, -5}, // Eastern Time (ET)
    {SAN, -8}, // Pacific Time (PT)
    {IAD, -5}, // Eastern Time (ET)
    {TPA, -5}, // Eastern Time (ET)
    {BNA, -6}, // Central Time (CT)
    {AUS, -6}, // Central Time (CT)
    {MDW, -6}, // Central Time (CT)
    {HNL, -10}, // Hawaii-Aleutian Standard Time (No DST)
    {DAL, -6}, // Central Time (CT)
    {PDX, -8}, // Pacific Time (PT)
    {STL, -6}, // Central Time (CT)
    {RDU, -5}, // Eastern Time (ET)
    {HOU, -6}, // Central Time (CT)
    {SMF, -8}, // Pacific Time (PT)
    {MSY, -6}, // Central Time (CT)
    {SJC, -8}, // Pacific Time (PT)
    {SNA, -8}, // Pacific Time (PT)
    {MCI, -6}, // Central Time (CT)
    {OAK, -8}, // Pacific Time (PT)
    {SAT, -6}, // Central Time (CT)
    {RSW, -5}, // Eastern Time (ET)
    {CLE, -6}, // Should be ET, but web scraping result shows Chicago time
    {IND, -5}, // Eastern Time (ET)
    {PIT, -5}, // Eastern Time (ET)
    {CVG, -5}, // Eastern Time (ET)
